...
const INPUT_MODES = ['manuscrita', 'digitada', 'upload'] as const;
const ESSAY_STATUSES = ['pendente', 'processando', 'corrigida', 'precisa_revisao', 'baixa_confiabilidade'] as const;
...
export type UpsertEssayInput = z.infer<typeof UpsertEssaySchema>;
export type UpsertTurmaInput = z.infer<typeof UpsertTurmaSchema>;
export type GetEssaysByTeacherInput = z.infer<typeof GetEssaysByTeacherSchema>;
export type TeacherEvalInput = z.infer<typeof TeacherEvalSchema>;
